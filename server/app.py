...
with app.app_context():
    ...
    if not Account.query.first():  # Check if there are any accounts
        ...
        grade1 = Grade(student1.student_id, course1.course_id, "6.25")
        grade2 = Grade(student1.student_id, course2.course_id, "9.75")
        grade3 = Grade(student1.student_id, course3.course_id, "8.50")
